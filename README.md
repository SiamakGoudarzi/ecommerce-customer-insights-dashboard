...
## Data Source
The dataset used for this project is the **Online Retail II** dataset, provided by the [UCI Machine Learning Repository](https://archive.ics.uci.edu/dataset/502/online+retail+ii). It contains all transactions occurring between 2009 and 2011 for a UK-based non-store online retail.

---

## Project Workflow
1. **Data Engineering:** Consolidating multi-year transaction data and rigorous data cleansing.
2. **Feature Engineering:** Deriving RFM metrics to quantify customer behavior.
3. **Modeling:** Implementing scalable ML pipelines for segmentation and classification.
4. **Deployment:** Providing a decision-support tool via an interactive dashboard.
